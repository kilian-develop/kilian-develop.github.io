...
이것이 바로 도메인 주도 설계(DDD)의 "Ubiquitous Language" 개념과 맞닿아있다는 생각이 들었습니다.
...
이 설정 파일 하나로:
- 어떤 프로필을 얼마나 중요하게 취급할 것인가
- 긴급 요청을 얼마나 빠르게 처리할 것인가

이런 **비즈니스 정책을 표현**할 수 있습니다. 코드 변경 없이 설정만 수정하면 동작을 바꿀 수 있다는 점이 강력했습니다.
